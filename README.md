...
**_NOTE:_** **This is a fork of the original [nativescript-oauth2 plugin](https://www.npmjs.com/package/nativescript-oauth2) unfortunately the author is not  responding since a month: it's not possible to merge the latest updates without his approval. In order to use this plugin, you must clone the repo and build it manually, sorry :/**
